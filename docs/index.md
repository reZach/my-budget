...
# Download
You can download the application [here](https://github.com/reZach/my-budget/releases/latest). The application is still in beta, so please be aware there may be breaking changes until we have stabilized for the first major release.
